...
All notable changes to Claude Menu Bar are documented here. This project follows
[Semantic Versioning](https://semver.org/).

## [0.3.0] - 2026-06-26

Forked from [claude-status-bar](https://github.com/m1ckc3s/claude-status-bar) by Mick Cesanek and rebranded as **Claude Menu Bar**.

### Changed
- Renamed app, bundle id, and binary to Claude Menu Bar (`com.local.claudemenubar`).
- Default accent color is now teal.

### Removed
- The once-a-day GitHub release check. The app now makes **no network calls** at all.
- Dead legacy LaunchAgent cleanup carried over from the original's 0.0.2 watcher.
...
[0.2.2]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.2.2
[0.2.1]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.2.1
[0.2.0]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.2.0
[0.1.0]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.1.0
[0.0.5]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.0.5
[0.0.4]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.0.4
[0.0.3]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.0.3
[0.0.2]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.0.2
[0.0.1]: https://github.com/cdbkk/claude-menubar/releases/tag/v0.0.1
